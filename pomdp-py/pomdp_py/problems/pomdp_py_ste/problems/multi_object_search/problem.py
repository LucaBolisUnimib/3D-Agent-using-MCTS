...
import pomdp_py
from pomdp_py_ste.problems.multi_object_search.env.env import *
from pomdp_py_ste.problems.multi_object_search.env.visual import *
from pomdp_py_ste.problems.multi_object_search.agent.agent import *
from pomdp_py_ste.problems.multi_object_search.example_worlds import *
from pomdp_py_ste.problems.multi_object_search.domain.observation import *
from pomdp_py_ste.problems.multi_object_search.models.components.grid_map import *
import argparse
import time
import random
import numpy as np
        ...
        if type(prior) == str:
            if prior == "uniform":
                ...
                for objid in env.target_objects:
                    ...
                    prior[objid] = {groundtruth_pose: 0.7}
            # print(prior)
